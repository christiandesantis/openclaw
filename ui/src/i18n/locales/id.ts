...
export const id: TranslationMap = {
  ...
  board: {
    ...
    widget: {
      ...
      actionErrorDetail: "Dasbor tetap mempertahankan status widget sebelumnya.",
  ...
  chat: {
    ...
    board: {
      ...
      resetDescription: "Konteks percakapan akan disetel ulang. Dasbor Anda tetap ada.",
    },
    catalog: {
