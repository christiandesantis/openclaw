...
export const ru: TranslationMap = {
  ...
  sessionsView: {
    ...
    deleteAllArchivedConfirm: "Удалить {count} заархивированных сессий и их стенограммы?",
  ...
  appsPage: {
    ...
    pairDevice: "Сопрягите ваше устройство",
  ...
  board: {
    ...
    emptyHint: "Ваш агент может закрепить здесь виджеты — попробуйте попросить карточку статуса.",
    ...
    widget: {
      cellLabel:
        "Виджет панели: {title}. Используйте стрелки для навигации. Удерживайте Alt и нажмите стрелку, чтобы переместить его.",
  ...
  chat: {
    ...
    board: {
      ...
      resetDescription: "Контекст беседы сбрасывается. Ваш дашборд остаётся.",
    },
    catalog: {
    ...
    messages: {
      ...
      rewindConfirm: "Вернуться к состоянию до этого сообщения?",
      rewindToHere: "Вернуться сюда",
      rewindUnavailable: "Возврат недоступен, пока агент работает",
