...
export const pl: TranslationMap = {
  ...
  mcpServers: {
    ...
    nameInvalid: "Nazwy serwerów używają liter, cyfr, kropek, myślników lub podkreśleń.",
    ...
    adminRequired: "Zmiany serwera MCP wymagają dostępu operator.admin.",
    enable: "Włącz",
    disable: "Wyłącz",
  ...
  board: {
    ...
    announcement: {
      ...
      granted: "Dostęp do widżetu dozwolony.",
  ...
  chat: {
    ...
    board: {
      ...
      mockRecentFindings: "Ostatnie wyniki",
    ...
    questions: {
      ...
      answered: "Odpowiedziano",
      answeredElsewhere: "Udzielono odpowiedzi gdzie indziej",
      expired: "Wygasł",
      cancelled: "Anulowano",
    },
    messages: {
