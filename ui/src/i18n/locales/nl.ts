...
export const nl: TranslationMap = {
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "Meldingen worden op deze Mac natief weergegeven door de OpenClaw-app.",
  ...
  sessionsPage: {
    hubTablistLabel: "Sessies-secties",
  },
  pluginsPage: {
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "Dashboardwidget: {title}. Gebruik de pijltjestoetsen om te navigeren. Houd Alt ingedrukt en druk op een pijltjestoets om hem te verplaatsen.",
      ...
      needsApprovalDetail: "Deze widget heeft extra toegang aangevraagd.",
      allow: "Toestaan",
      reject: "Weigeren",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "Gekopieerd",
      branches: "Sessievertakkingen",
      branchSwitchUnavailable:
        "Overschakelen naar een andere vertakking is niet beschikbaar terwijl de agent werkt.",
    ...
    board: {
      ...
      mockPlaceholder: "Board-weergavenaad · {tabs} tabbladen · {widgets} widgets",
    ...
    modelControls: {
      ...
      usingDefault: "Standaard van Instellingen gebruiken",
