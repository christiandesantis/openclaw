...
export const pt_BR: TranslationMap = {
  ...
  agentChip: {
    ...
    offlineOpenSettings: "Offline — abra as Configurações",
  ...
  custodian: {
    ...
    requestFailed: "O OpenClaw não pôde responder. Tente novamente.",
    connectionChanged:
  ...
  appsPage: {
    ...
    heroTagline:
      "Aplicativos complementares para o seu celular, relógio, desktop e navegador — além de plugins para expandir o que o seu agente pode fazer.",
    ...
    cards: {
      ...
      macos: {
        title: "macOS",
        desc: "Aplicativo complementar na barra de menus para o seu Gateway — notificações, aprovações, conversa rápida.",
      },
      windows: {
        title: "Windows",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "Copiado",
      branches: "Ramificações da sessão",
    ...
    messages: {
      ...
      hide: "Ocultar",
      hideConfirm: "Ocultar esta mensagem neste navegador? O agente continua a vê-la.",
