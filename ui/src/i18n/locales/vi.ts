...
export const vi: TranslationMap = {
  ...
  mcpServers: {
    ...
    nameInvalid:
      "Tên máy chủ sử dụng chữ cái, chữ số, dấu chấm, dấu gạch ngang hoặc dấu gạch dưới.",
  ...
  sessionsPage: {
    hubTablistLabel: "Các mục Sessions",
  },
  pluginsPage: {
  ...
  appsPage: {
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Xem nhanh các cuộc trò chuyện và trả lời nhanh ngay trên cổ tay của bạn.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  board: {
    ...
    emptyHint: "Agent của bạn có thể ghim widget ở đây — thử yêu cầu một thẻ trạng thái.",
  ...
  chat: {
    ...
    board: {
      ...
      dockBottom: "Gắn trò chuyện bên dưới",
    ...
    messages: {
      ...
      forkUnavailable: "Không thể phân nhánh khi agent đang làm việc",
    ...
    modelControls: {
      ...
      usingDefault: "Dùng mặc định từ Cài đặt",
