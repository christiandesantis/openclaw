...
export const es: TranslationMap = {
  ...
  chat: {
    ...
    board: {
      faceLabel: "Cara de sesión",
      chatFace: "Chat",
      dashboardFace: "Panel",
      dockMenu: "Acople del chat: {dock}",
      ...
      resizeDock: "Redimensionar acople del chat",
    ...
    messages: {
      ...
      hide: "Ocultar",
      hideConfirm: "¿Ocultar este mensaje en este navegador? El agente aún puede verlo.",
    ...
    modelControls: {
      ...
      usingDefault: "Usando valor predeterminado de Configuración",
