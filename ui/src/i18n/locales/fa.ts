...
export const fa: TranslationMap = {
  ...
  custodian: {
    ...
    nudge: {
      ...
      dismiss: "این به‌روزرسانی را ببندید",
    },
  },
  mcpServers: {
    add: "افزودن سرور",
    ...
    targetInvalid: "یک نشانی http(s) یا خط فرمان وارد کنید.",
  ...
  appsPage: {
    ...
    heroTagline:
      "اپلیکیشن‌های همراه برای گوشی، ساعت، رومیزی و مرورگر شما — به‌همراه پلاگین‌هایی برای گسترش توانایی‌های عامل شما.",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "گفتگوهای قابل مشاهده در یک نگاه و پاسخ‌های سریع از مچ دست شما.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      plugins: {
        ...
        desc: "OpenClaw را با کانال‌ها، ابزارها و Skills از جامعه کاربران گسترش دهید.",
      },
    },
  },
  profilePage: {
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "ویجت داشبورد: {title}. برای پیمایش از کلیدهای جهت‌دار استفاده کنید. Alt را نگه دارید و یک کلید جهت‌دار را فشار دهید تا آن را جابه‌جا کنید.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "کپی شد",
      branches: "شاخه‌های نشست",
      branchSwitchUnavailable: "هنگام کار عامل، جابه‌جایی شاخه در دسترس نیست.",
      branchSwitchRequiresAdmin: "جابه‌جایی شاخه نیازمند دسترسی مدیر اپراتور است.",
