...
export const ko: TranslationMap = {
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "클라우드 워커는 OpenClaw 런타임이 필요합니다. {runtime}이(가) 선택되었습니다.",
  ...
  custodian: {
    ...
    nudge: {
      configReload: "구성 다시 로드가 중단됨 — 무슨 일이 있었는지 물어보세요",
      channelAuth: "{channel} 인증이 저하됨 — 무슨 일이 있었는지 물어보세요",
      channelDisconnected: "{channel} 연결이 끊김 — 무슨 일이 있었는지 물어보세요",
      channelDegraded: "{channel}이(가) 저하됨 — 무슨 일이 있었는지 물어보세요",
      channelFallback: "채널",
      dismiss: "이 업데이트 무시",
    },
  },
  ...
  appsPage: {
    ...
    heroTagline:
      "휴대폰, 시계, 데스크톱, 브라우저를 위한 컴패니언 앱과 에이전트의 기능을 확장하는 플러그인.",
    sectionMobile: "휴대폰에서",
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "대시보드 위젯: {title}. 화살표 키로 이동합니다. Alt를 누른 상태에서 화살표 키를 누르면 위젯을 옮길 수 있습니다.",
      moveHandle: "{title} 이동",
      ...
      remove: "제거",
      needsApproval: "승인 필요",
      needsApprovalDetail: "이 위젯이 추가 접근 권한을 요청했습니다.",
      allow: "허용",
      reject: "거부",
      rejected: "접근 거부됨",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "복사됨",
      branches: "세션 브랜치",
      branchSwitchUnavailable: "에이전트가 작업하는 동안에는 브랜치를 전환할 수 없습니다.",
    ...
    board: {
      ...
      resetDescription: "대화 컨텍스트가 초기화됩니다. 대시보드는 그대로 유지됩니다.",
    },
    catalog: {
    ...
    messages: {
      ...
      forkUnavailable: "에이전트가 작업하는 동안에는 포크를 사용할 수 없습니다",
