...
export const uk: TranslationMap = {
  ...
  sessionsView: {
    ...
    sessionsArchived: "Заархівовано {count} сесій",
  ...
  mcpServers: {
    ...
    nameTaken: "MCP-сервер з іменем «{name}» уже існує.",
  ...
  mcpPage: {
    connectorsLink: "Відкрийте конектори в один клік на сторінці Plugins.",
    servers: "Сервери",
    oauth: "OAuth",
  ...
  appsPage: {
    ...
    cards: {
      ...
      windows: {
        title: "Windows",
        desc: "Windows-компаньйон підключає ваш ПК як вузол OpenClaw.",
      },
      linux: {
        title: "Linux",
  ...
  board: {
    ...
    actionFailed: "Не вдалося зберегти зміни на панелі.",
  ...
  chat: {
    ...
    board: {
      ...
      mockPlaceholder: "Стик перегляду дошки · {tabs} вкладок · {widgets} віджетів",
      mockOverview: "Огляд",
