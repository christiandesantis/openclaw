...
export const zh_CN: TranslationMap = {
  ...
  sessionsView: {
    ...
    deleteAllArchivedConfirm: "删除 {count} 个已归档会话及其转录记录？",
  ...
  appsPage: {
    ...
    heroTagline: "适用于手机、手表、桌面和浏览器的配套应用——以及扩展你的智能体功能的插件。",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "从你的手腕上一目了然地查看聊天并快速回复。",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Android 伴侣应用将 OpenClaw 扩展到你的手表上。",
      },
      macos: {
        title: "macOS",
        desc: "Gateway 的菜单栏助手——通知、审批、快速聊天。",
      },
      windows: {
        title: "Windows",
        desc: "Windows 助手将你的 PC 作为 OpenClaw 节点连接。",
      },
      linux: {
        title: "Linux",
      ...
      plugins: {
        title: "插件与 ClawHub",
        desc: "通过社区的渠道、工具和 Skills 扩展 OpenClaw。",
      },
    },
  },
  profilePage: {
  ...
  board: {
    ...
    emptyHint: "你的智能体可以在此固定小部件——试试请求一张状态卡片。",
    ...
    widget: {
      ...
      reject: "拒绝",
      rejected: "访问被拒绝",
      rejectedDetail: "此小组件在被移除或替换前将保持未激活状态。",
  ...
  chat: {
    ...
    board: {
      ...
      mockSourceMap: "来源映射",
      resetTitle: "重置对话？",
      resetDescription: "对话上下文将重置。您的仪表板会保留。",
    },
    catalog: {
