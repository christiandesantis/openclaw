...
export const tr: TranslationMap = {
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "OpenClaw için bildirimler macOS'ta devre dışı. Bunlara Sistem Ayarları > Bildirimler bölümünden izin verin.",
    },
    appearance: {
      theme: "Tema",
  ...
  subtitles: {
    ...
    notifications: "Gateway'inizden tarayıcı push bildirimleri.",
  ...
  custodian: {
    ...
    nudge: {
      configReload: "Yapılandırma yeniden yüklemesi durdu — ne olduğunu bana sor",
      channelAuth: "{channel} kimlik doğrulaması bozuldu — ne olduğunu bana sor",
      channelDisconnected: "{channel} az önce bağlantısı kesildi — ne olduğunu bana sor",
      channelDegraded: "{channel} bozuk durumda — ne olduğunu bana sor",
