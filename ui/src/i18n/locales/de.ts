...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    advanced: "Alle übrigen Konfigurationsbereiche sowie der Roh-Datei-Editor.",
  ...
  custodian: {
    title: "OpenClaw",
    subtitle: "Ihr Anleitung zur Systemeinrichtung",
    exitSetup: "Einrichtung verlassen",
    hatchDraft: "Aufwachen, mein Freund!",
  ...
  appsPage: {
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Chatte, sprich, genehmige Aktionen und teile in OpenClaw über iOS.",
      },
      android: {
        title: "Android",
      ...
      macos: {
        title: "macOS",
        desc: "Menüleisten-Begleiter für dein Gateway – Benachrichtigungen, Freigaben, schneller Chat.",
      },
      windows: {
        title: "Windows",
  ...
  board: {
    ...
    emptyHint: "Dein Agent kann hier Widgets anheften – bitte zum Beispiel um eine Statuskarte.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "Kopiert",
      branches: "Sitzungszweige",
      branchSwitchUnavailable: "Der Zweigwechsel ist nicht verfügbar, während der Agent arbeitet.",
      branchSwitchRequiresAdmin: "Der Zweigwechsel erfordert Operator-Admin-Zugriff.",
    ...
    modelControls: {
      ...
      sessionOverride: "Sitzungs-Überschreibung",
