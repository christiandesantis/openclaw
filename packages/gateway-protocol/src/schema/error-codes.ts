...
export const GatewayErrorDetailCodes = {
  ...
  CLIENT_MODE_FORBIDDEN: "CLIENT_MODE_FORBIDDEN",
} as const;
...
/** Client-mode restriction details for RPCs blocked independently of request params. */
export const ClientModeForbiddenErrorDetailsSchema = closedObject({
  code: Type.Literal(GatewayErrorDetailCodes.CLIENT_MODE_FORBIDDEN),
...
export const GatewayErrorDetailsSchema = Type.Union(
  [MissingScopeErrorDetailsSchema, ClientModeForbiddenErrorDetailsSchema],
  { discriminator: "code" },
);

export type MissingScopeErrorDetails = Static<typeof MissingScopeErrorDetailsSchema>;
export type ClientModeForbiddenErrorDetails = Static<typeof ClientModeForbiddenErrorDetailsSchema>;
